<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="mechanic.aspx.cs" Inherits="Otomotiv_Yedek_Parça_E_Ticaret_Sitesi.mechanic" %>
              ...
              <div class="row">
               ...
               <div class="col-lg-2">
                   <div class="pull-right">
                      <a style="font-weight: bold;font-size:15px;text-decoration:underline !important;" href="login.aspx?mechanic.aspx" id="linkAyarla" runat="server">Giriş Yap</a>  
                 ...
                 <div class="col-md-2" style="height:fit-content;margin:50px 0px;padding:15px;box-shadow: 0 2px 4px 0 rgba(0,0,0,.6);background-color:#fff;">
                     <h2>Kategoriler</h2>
                        <asp:Repeater runat="server" ID="Repeater2">
                            <ItemTemplate>
                                <label class="p" style="color:black;"><input id="CheckBox1" checked="checked" name="CheckBox1" class="checkmark" type="checkbox" runat="server" value='<%# Eval("kategori") %>'>
                                    <asp:Label CssClass="h6" style="font-weight:400;margin-left:30px;" runat="server"><%# Eval("kategori") %></asp:Label></label>
                                <br />
                            </ItemTemplate>
                      </asp:Repeater>
                </div>
                    ...
                    <div class="fa-border" style="border-color:black;border-width:0px;border-radius:30px;background-color:#c7c7c7;padding:5px 20px !important;">
                        <div class="row product_section" style="margin-bottom:25px;">                  
                            ...
                            <asp:Repeater runat="server" ID="Repeater1">
                                <ItemTemplate>
                                    <div class="col-lg-3 <%# Eval("kategori") %>"> 
                                        <a href="urun.aspx?<%# Eval("urunID") %>">
                                            <div class="full product_blog btn-outline-primary margin_top_30" style="height:375px;border-radius:20px;">
                                                ...
                                                <img style="width:auto;max-width:100%;max-height:200px;margin-right:auto;margin-left:auto;display:block;" src="<%# Eval("resim") %>" alt="#" />
                                                <h3><%# Eval("urun") %> <%# Eval("kategori") %></h3>
                                                <h2 style="bottom: 5%;position: absolute;text-align: center;left: 10%;right: 10%;">
                                                    <span style="color: #27ff00 !important;font-weight:500;"><%# Eval("fiyat") %> TL</span>
                                                </h2>
                                            </div>
                                        </a>
                                    </div>
